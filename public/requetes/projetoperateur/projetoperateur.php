    ...
    <form action="" id="RequeteProOp">
        <div class="col-md-4 col-lg-4 col-sm-4">
            <fieldset>
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12" id="blocProjet">
                        ...
                        <select class="formulaire" id="nomPro" name="nomPro">
                            ...
                            <option value="-1">Aucun projet</option>
                            <?php
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12" id="blocOperateur">
        ...
        <div class="col-lg-3 col-md-3 col-sm-3">
            <fieldset>
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12" id="blocAmenagement">
                        ...
                        <div class="row">
                            <div class="form-group" style="margin-left: 10px; margin-right: 10px">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                     Cette requête permet de lister les projets <br />
                                    o	Par unité géographique (région, province, commune,  localité)<br />
                                    o	ceux qui sont achevés ou non<br />
...
<script type="application/javascript">
    ...
    $('#valider').click(function(){
        ...
        var data="region="+region+"&province="+province+"&commune="+commune+"&localite="+localite+"&nomcat="+nomCat+"&amenge="+amenage+
            "&projet="+projet+"&operateur="+operateur+"&annee="+annee;

        $.ajax({
            type: "GET",
            url:"<?php echo $RACINE_REQUETES;?>requetes/projetoperateur/traitementRecherche.php",
            data:data,
            success: function(reponse){
                //notification(1);
