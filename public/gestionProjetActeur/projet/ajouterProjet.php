...
<div class="modal" id="newprojet" data-backdrop="static">
    <div class="modal-dialog" style="width: 60%">
        <div class="modal-content" style="background-color: white;">
            <div class="modal-header" style="border-color: #E4F6EA; background-color: #FFFFFF; margin-top: 0px; padding: 0px; border-bottom: 5px solid #4C9ED9; min-height: 20px">
                ...
                <br />
                <h3 style="padding-left: 5px; padding-top: 5px;" >Ajout d'un projet</span></h3>
            </div>
            ...
            <div class="row">
                <div class="col-md-4 col-sm-4 col-lg-4">
                        ...
                        <input type="text" name="nomPro" id="nomPro" class="formulaire" required onchange="EnleverFocus(this.id)">
                </div>
                <div class="col-md-4 col-sm-4 col-lg-4">
                    <label for="budgetGlobal">Budget global (Fcfa) <span style="color: red">*</span></label><br>
                    <input type="number" min="0" name="budgetGlobal" id="budgetGlobal" class="formulaire" required onchange="EnleverFocus(this.id)">
                    <span class="erreurglobal" aria-live="polite"></span>
                </div>
                <div class="col-md-4 col-sm-4 col-lg-4">
                    <label for="budgetGMV">Budget GMV (Fcfa) <span style="color: red">*</span></label><br>
                    <input type="number" min="0" name="budgetGMV" id="budgetGMV" class="formulaire" required onchange="EnleverFocus(this.id)">
            ...
            <div class="row">
                    ...
                    <div class="col-md-4 col-sm-4 col-lg-4">
                        ...
                        <input type="text" name="dateDeb" id="dateDeb" class="formulaire calendrier" required onchange="EnleverFocus(this.id)">
                    </div>
                    <div class="col-md-4 col-sm-4 col-lg-4">
                        <label for="dateFin">Date de fin du projet <span style="color: red">*</span></label><br>
                        <input type="text" name="dateFin" id="dateFin" class="formulaire calendrier" required onchange="EnleverFocus(this.id)">
                    </div>
                    <div class="col-md-4 col-sm-4 col-lg-4">
                        <label for="nomContPro">Nom du contact du projet <span style="color: red">*</span></label><br>
                        <input type="text" name="nomContPro" id="nomContPro" class="formulaire" required onchange="EnleverFocus(this.id)">
                    </div>
            </div><br>
            <div class="row">
                    ...
                    <div class="col-md-4 col-sm-4 col-lg-4">
                        ...
                        <input type="text" name="prenomContPro" id="prenomContPro" class="formulaire" required onchange="EnleverFocus(this.id)">
                    </div>
                    <div class="col-md-4 col-sm-4 col-lg-4">
                        <label for="numContPro">Numéro du contact du projet <span style="color: red">*</span></label><br>
                        <input type="text" title="format XX XX XX XX" name="numContPro" id="numContPro" class="formulaire"
                    ...
                    <div class="col-md-4 col-sm-4 col-lg-4">
                        ...
                        <input type="text" name="siteInt" id="siteInt" class="formulaire" required>
                    </div>
            </div><br>
            <div class="row">
                    <div class="col-md-4 col-sm-4 col-lg-4">
                    ...
                    <div class="row">
                        <div class="col-md-4 col-sm-4 col-lg-4">
                                <fieldset id="lieu">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 col-sm-12 col-lg-12" id="affichCommune">
                                            <label>commune sélectionnée</label>
                                            <input type="hidden" id="nbreC" value="0">
                                            <p id="selectCommune">
                                ...
                                <fieldset id="financeur">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 col-sm-12 col-lg-12" id="afficheBailleur">
                                            ...
                                            <input type="hidden" id="nbreB" value="0">
                                            <p id="selectBailleur">
                                ...
                                <fieldset id="executant">
                                        ...
                                        <div class="col-md-12 col-sm-12 col-lg-12">
                                            ...
                                            <select class="formulaire" id="nomOpt" name="nomOpt" >
                                                ...
                                                foreach($operateur as $Opt):
                                                    ...
                                                    $nom=$nom+8;
                                                    ?>
                                                    <option id="operateur<?php echo $id ?>" value="<?php echo $id ?>"><?php echo $nomOpt; ?></option>
                                                <?php endforeach ?>
                                            </select>
                                        </div>
                                    </div><br>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 col-sm-12 col-lg-12" id="afficheOperateur">
                                            ...
                                            <input type="hidden" id="nbreOp" value="0">
                                            <p id="selectOpt">
...
<script type="application/javascript">
   ...
   $('#ListeBailleur').change(function(){
    ...
    $('#afficheBailleur').hide();
    $('#afficheOperateur').hide();
    $('#valeurBailleur').hide();
    $('#affichCommune').hide();
    $('#montExec').hide();
    $('#fonction').hide();
        ...
        if(nom!="" && qte!='') {
            ...
            if(dernier!=0){
                ...
                if(flag!=1){
                    ...
                    $.rtnotify({
                        title: "",
                        message: " Ce Bailleur existe sur la liste ",
                        type: "error",
                        permanent: false,
                        timeout: 5,
                        fade: true,
                          ...
                          if (bailleur != '') {
                              if (operateur != '') {
                                  var data = "nomPro=" + nomPro + "&siteInt=" + siteInt + "&budgetGlobal=" + budgetGlobal + "&budgetGMV=" + budgetGMV + "&dateDeb=" + dateDeb + "&dateFin=" + dateFin +
                                      ...
                                      "&financiere=" + finance + "&operateur=" + operateur + "&montantOp=" + montantOp + "&nbreOp=" + nbreOp+"&type=ajout";
                                  $.ajax({
                                      type: "POST",
