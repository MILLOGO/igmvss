...
*/
    ...
    <div class="row zone_filtre" style="text-align: center">
        <label style="font-size: 18pt">Liste du type des collectifs</label>
    </div>
    <br>
    <div class="row">
        <div >
        ...
        <div >
            <table class="table table-striped myTable" >
                ...
                <th></th>
                <th style="text-align: center">Type du collectif</th>
                <th> </th>
                <th> </th>
                </thead>
                <tbody>
                ...
                foreach ($tableau as $tab):
                    ...
                    <tr>
                        ...
                        <td style="text-align: right"><a href="#" onclick="$('#envoi').load('./parametre/typeducollectif/modifierTypeducollectif.php',{id : <?php echo $id; ?>},function(){
                                $('#updatecategorie').modal();});" title="modifier"><i class="fa fa-pencil" style="color: #060"></i></a></td>
                        <td><a  href="#" onclick="$('#envoi').load('./parametre/typeducollectif/supprimerTypecollectif.php',{id : <?php echo $id; ?>},function(){
        ...
        <br>
        <a href="./parametre/typeducollectif/exportExcel.php" title="Exporter"><input type="button" value="Exporter la liste" class="pull-right btn btn-primary"></a>
        ...
        <div class="modal-dialog">
            <div class="modal-content" style="background-color: white;">
                <div class="modal-header" style="border-color: #E4F6EA; background-color: #FFFFFF; margin-top: 0px; padding: 0px; border-bottom: 5px solid #4C9ED9; min-height: 20px">
                    ...
                    <br />
                    <h3 style="padding-left: 5px; padding-top: 5px;" >Ajout d'un type de collectif</span></h3>
                </div>
                <div class="modal-body">
                    <form class="form-horizontal" style="margin-top: 10px" action="">
                        <fieldset>
                            <legend>Nouveau type du collectif</legend>
                            <div class="row">
                                <div class="form-group" style="margin-left: 10px; margin-right: 10px">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <label for="nomCatAm">Nom du type de collectif <span style="color: red">*</span></label><br />
...
//        "bInfo": false
        ...
        $("#validerCatAm").click(function(){
            ...
            if(Catam==''){
                ...
                $.ajax({
                    type:"POST",
                    url:"./parametre/typeducollectif/enregistrement.php",
                    data:data,
