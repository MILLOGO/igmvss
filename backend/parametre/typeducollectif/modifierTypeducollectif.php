            ...
            <div class="modal-content" style="background-color: white;">
                ...
                <div class="modal-body">
                    <form class="form-horizontal" style="margin-top: 10px" action="">
                        <?php $tableau=Bd_parametre::ListeTypeCollectifParId($identifiant);
                        foreach($tableau as $tabDne):
                            ?>
                            <fieldset>
                                <legend>Modification d'un type de collectif</legend>
                                <div class="row">
                                    <div class="form-group" style="margin-left: 10px; margin-right: 10px">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">

                                            <label for="CatAm">Nom du type du collectif <span style="color: red">*</span></label><br />
