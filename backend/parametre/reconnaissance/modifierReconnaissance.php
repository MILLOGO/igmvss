...
$tableau=Bd_parametre::ListeReconnaissanceParId($idregion);
$id=1;
$nom=2;
?>
    <div id="Etatenregistrement"></div>
<div class="modal" id="updatereconnaissance" data-backdrop="static">
        ...
        <div class="modal-content" style="background-color: white;">
            ...
            <div class="modal-body">
                <form class="form-horizontal" style="margin-top: 10px" action="">
                    <fieldset>
                        <legend>Modification de la réconnaissance</legend>
                        <div class="row">
                            <div class="form-group" style="margin-left: 10px; margin-right: 10px">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <label for="nomregion">Nom de la réconnaissance <span style="color: red">*</span></label><br />
                                    <?php foreach ($tableau as $tab):
                                        $idregion=$tab[$id];
                                        $nomregion=$tab[$nom];
                                    ?>
                                        <input type="hidden" name="idregi" id="idregi"  class="formulaire" value="<?php echo $idregion; ?>">
                                        <input type="text" name="reconnaissan" id="reconnaissan"  class="formulaire" value="<?php echo $nomregion; ?>" onchange="EnleverFocus(this.id)">
                                    <?php endforeach ?>
                                        <br />
                                </div>
                            </div>
