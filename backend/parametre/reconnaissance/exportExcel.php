...
if(!$_SESSION){
    ...
    $filename = 'Liste des Reconnaissances-' . $dat . '.xlsx';
    ...
    $tableau = Bd_parametre::ListeReconnaissance();
    ...
    $writer->writeSheetHeader('feuil1', array('Numéro' => 'integer', 'Nom de la réconnaissance' => 'string'), $format);
    $i = 1;
    $taille = 14;
