...
if(!$_SESSION){
    ...
    $filename = 'Liste des Catégories d\'aménagements-' . $dat . '.xlsx';
    ...
    $writer->writeSheetHeader('feuil1', array('Numéro' => 'integer', 'Nom de la catégorie d\'aménagement' => 'string'), $format);
    $i = 1;
    $taille = 14;
