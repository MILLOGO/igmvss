...
$tableau=Bd_parametre::ListeRegionParId($idregion);
$id=1;
$nom=2;
?>

<div class="modal" id="updateregion" data-backdrop="static">
        ...
        <div class="modal-content" style="background-color: white;">
            ...
            <div class="modal-body">
                <form class="form-horizontal" style="margin-top: 10px" action="">
                    <fieldset>
                        <legend>Modification de la région</legend>
                        <div class="row">
                            <div class="form-group" style="margin-left: 10px; margin-right: 10px">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    ?>
                                        ...
                                        <input type="text" name="nomregion" id="nomregion"  class="formulaire" value="<?php echo $nomregion; ?>" onchange="EnleverFocus(this.id)">
                                    <?php endforeach ?>
                                        <br />
                                </div>
                            </div>
