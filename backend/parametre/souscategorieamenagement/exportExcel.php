...
if(!$_SESSION){
    ...
    $filename = 'Liste des Sous-Catégories d\'aménagements-' . $dat . '.xlsx';
    ...
    $tableau = Bd_parametre::ListeSousCategorie();
    ...
    $writer->writeSheetHeader('feuil1', array('Numéro' => 'integer', 'Nom de la Sous-catégorie d\'aménagement' => 'string'), $format);
    $i = 1;
    $taille = 14;
