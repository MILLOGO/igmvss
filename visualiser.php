...
<head>
    ...
    <script type="application/javascript" src="./style/js/visiteurjs.js"></script>
    ...
    <div class="row">
        <div class="col-sm-12 col-lg-12 col-md-12 banniere">
            <div class="col-sm-1 col-lg-1 col-md-1">
                <img src="./style/images/logo.png"  height="100px"  alt="Logo">
            </div>
...
<div class="container-fluid" style="background-image: url(../style/images/fond1.png); background-repeat: repeat-x;">
    <div class="row">
        <div class="col-md-12" style="text-align:right; margin-bottom:0px;">
            <?php if($_SESSION){?>
                    <?php echo ("Bienvenue "); ?>  <strong class="maj">
                        <?php echo $_SESSION['prenom']." ". $_SESSION['nom'];

                ?></strong> &nbsp; - &nbsp;Votre profil (<span style="font-weight: bold">
                ...
                <a href="./logout.php" style="color: #ff0000; text-decoration: none">Se déconnecter <i class="fa fa-power-off"></i></a>
                <?php }else{
                    echo "Visualisation des données";?>&nbsp; - &nbsp;
                <a href="index.php" style="color: #060; text-decoration: none">Se connecter </a>
        <?php  } ?>
        </div> <!-- col md 12 -->
    </div>
        <div class="col-md-2 col-sm-2 col-lg-2" style="padding-right: 5px; padding-left: 0px;">
            ...
            <?php if($_SESSION['profil']==1 ||$_SESSION['profil']==2 ){?>
                <div class="panel panel-menu">
                    ...
                    <div id="gestionpro" class="panel-collapse collapse">
                        <div class="panel-body">
                            <table class="table" style="">
                                <tr id="ligne0" onclick="Activer(this.id);" class="centrer"><td><a class="menu-vertical" href="#" id="bailleur">Bailleur</a></td></tr>
                    ...
                    <div id="gestionsite" class="panel-collapse collapse">
                        <div class="panel-body">
                            <table class="table">
                                ...
                                <tr id="ligne8" onclick="Activer(this.id);" class="centrer"><td><a class="menu-vertical" href="#" id="revenu">Revenu gestionnaires </a></td></tr>
                ...
                <div class="panel panel-menu">
                    ...
                    <div id="requetes" class="panel-collapse collapse in">
                        <div class="panel-body">
                            <table class="table">
                                <tr id="ligne11" onclick="Activer(this.id);" class="centrer <?php if(!$_SESSION ){ echo "active"; }?> "><td><a href="#" id="reqAmenagement">Aménagement</a></td></tr>
                                <tr id="ligne12" onclick="Activer(this.id);" class="centrer"><td><a href="#" id="reqProjetoperateur">Projet Opérateur</a></td></tr>
                                <tr id="ligne13" onclick="Activer(this.id);" class="centrer"><td><a href="#" id="reqProjetmontant">Projet Montant</a></td></tr>
                                <tr id="ligne14" onclick="Activer(this.id);" class="centrer"><td><a href="#" id="reqOperateurmontant">Opérateur Montant</a></td></tr>
